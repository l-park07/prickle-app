...
export const TRIGGER_CATALOG: TriggerCategory[] = [
  {
    ...
    triggers: [
      { id: 'dust',             label: 'Dust',             blurb: '',             detail: "Dust can be made up of mites whose droppings eat away at your skin's protective barrier, letting irritants sneak in and cause an itchy red flare." },
      { id: 'pet-hair',         label: 'Pet hair',         blurb: '',         detail: "Tiny flakes of pet skin and dried saliva slip through eczema's weak barrier and trigger an allergic reaction." },
      { id: 'mold',             label: 'Mold',            blurb: '',            detail: "Floating mold spores in the air land on eczema and cause your body to overreact and flare." },
      { id: 'indoor-heating',   label: 'Indoor heating',   blurb: '',   detail: "Heaters create dry indoor air and low humidity, which strips away your skin's natural moisture and primes it for dry, cracking flare-ups." },
      { id: 'air-conditioning', label: 'Air conditioning', blurb: '',               detail: 'Air conditioning drops the humidity in a room and causes rapid temperature changes, which dry out the skin and make flares more likely.' },
  ...
  },
  {
    ...
    triggers: [
      { id: 'pollen',        label: 'Pollen',        blurb: '',        detail: 'Floating pollen acts as an allergen; when it lands on sensitive skin, it signals your immune system to overreact, causing a flare.' },
      { id: 'cold-weather',  label: 'Cold weather',  blurb: '',  detail: 'Cold air holds very little moisture and physically shocks the skin, creating a harsh environment that leaves your skin brittle and prone to cracking.' },
      { id: 'dry-air',       label: 'Dry air',       blurb: '',       detail: 'Without enough moisture in the air, your skin has a difficult time retaining moisture, causing severe dryness and subsequent flares.' },
      { id: 'heat',          label: 'Heat',          blurb: '',          detail: 'Hot temperatures make you sweat and increase blood flow to the skin, which can cause overheating, a prickly sensation, and begining the intense itch-scratch cycle.' },
      { id: 'humidity',      label: 'Humidity',      blurb: '',      detail: 'Thick, moist air makes you sweat more. When that sweat evaporates, it leaves behind a salty residue that stings and irritates broken skin.' },
      { id: 'sun',           label: 'Sun',           blurb: '',           detail: 'While a little sunlight helps some people, intense UV rays can essential burn and dry out already damaged skin barriers, making it harder for your skin to hold onto moisture.' },
      { id: 'air-pollution', label: 'Air pollution', blurb: '', detail: 'Microscopic dirt and chemicals from polluted air can settle on your skin, acting like a harsh physical irritant that makes your skin even more flare prone.' },
    ],
  },
  {
    id: 'ingesting',
